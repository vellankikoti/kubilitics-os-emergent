...
export default function ControllerRevisions() {
  ...
  const { data, isLoading, isFetching, dataUpdatedAt, refetch, pagination: hookPagination } = usePaginatedResourceList<K8sControllerRevision>('controllerrevisions');
  ...
  const deleteResource = useDeleteK8sResource('controllerrevisions');
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
      <ListPageHeader
        ...
        subtitle="Namespaced · Revision history for StatefulSets and DaemonSets"
