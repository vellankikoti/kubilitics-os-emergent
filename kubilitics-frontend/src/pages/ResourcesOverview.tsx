    ...
    return (
        <div className="p-6 space-y-8 max-w-[1600px] mx-auto pb-20">
            <SectionOverviewHeader
                ...
                description="Manage resource quotas and limit ranges."
                icon={Gauge}
                onSync={handleSync}
                isSyncing={isSyncing}
            />
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <Card className="bg-card/50 backdrop-blur-sm border-primary/10">
                    <CardContent className="pt-6">
                        <div className="flex items-center justify-between mb-2">
                            <span className="text-sm font-medium text-muted-foreground">Resource Quotas</span>
                            <Gauge className="h-4 w-4 text-primary" />
                        </div>
                        <div className="text-3xl font-bold">
                            {data?.resources.filter(r => r.kind === 'ResourceQuota').length}
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="bg-card/50 backdrop-blur-sm border-primary/10">
                    <CardContent className="pt-6">
                        <div className="flex items-center justify-between mb-2">
                            <span className="text-sm font-medium text-muted-foreground">Limit Ranges</span>
                            <Scale className="h-4 w-4 text-blue-500" />
                        </div>
                        <div className="text-3xl font-bold">
                            {data?.resources.filter(r => r.kind === 'LimitRange').length}
                        </div>
                    </CardContent>
                </Card>
            </div>
