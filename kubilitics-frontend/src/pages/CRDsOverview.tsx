    ...
    return (
        <div className="p-6 space-y-8 max-w-[1600px] mx-auto pb-20">
            <SectionOverviewHeader
                ...
                description="Browse and manage Custom Resource Definitions."
                icon={FileCode}
                onSync={handleSync}
                isSyncing={isSyncing}
            />
                ...
                <Card className="bg-card/50 backdrop-blur-sm border-primary/10">
                    <CardContent className="pt-6">
                        <div className="flex items-center justify-between mb-2">
                            <span className="text-sm font-medium text-muted-foreground">CRDs Installed</span>
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-muted/30">
                                ...
                                <th className="px-6 py-4 text-sm font-semibold text-muted-foreground border-b border-primary/5">Group</th>
