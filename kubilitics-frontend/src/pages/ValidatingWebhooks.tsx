...
export default function ValidatingWebhooks() {
  ...
  const { data, isLoading, isFetching, dataUpdatedAt, refetch } = useK8sResourceList<ValidatingWebhookResource>('validatingwebhookconfigurations', undefined, { limit: 5000 });
